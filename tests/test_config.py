...
CONFIG = {"cv_display_names": {
    "CV_Michel_Guillon_2026_Airwallex": "Fintech CV_Solutions_Leadership",
    "CV_Michel_Guillon_2026_AI": "CV_AI_Leadership",
}}


def test_display_name_maps_full_filename_with_and_without_extension():
    assert cv_display_name(CONFIG, "CV_Michel_Guillon_2026_Airwallex.docx") == "Fintech CV_Solutions_Leadership"
    assert cv_display_name(CONFIG, "CV_Michel_Guillon_2026_Airwallex") == "Fintech CV_Solutions_Leadership"
...
def test_display_name_maps_short_cv_form():
    ...
    assert cv_display_name(CONFIG, "Airwallex") == "Fintech CV_Solutions_Leadership"
